...
struct _R {
  ...
  struct image {
    ...
    /// Image `password_icon`.
    var password_icon: RswiftResources.ImageResource { .init(name: "password_icon", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
  ...
  struct font: Sequence {
    ...
    func makeIterator() -> IndexingIterator<[RswiftResources.FontResource]> {
      [sfuiDisplayRegular].makeIterator()
    }
    func validate() throws {
      for font in self {
